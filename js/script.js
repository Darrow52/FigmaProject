document.addEventListener("DOMContentLoaded", () => {
    ...
    onePod.addEventListener("click", (event) => {
        ...
        // Если кликнули по элементу выбора
        // внутри открытого One Pod — ничего не делаем
        if (
...
document.addEventListener("click", function (e) {
    ...
    const sizeOption = e.target.closest(
        "one-pod-option size-option"
    );
...
/* =========================
   PRODUCT GALLERY (Frame 7)
   Клик по миниатюре -> она обводится
   и показывается как большое изображение сверху.
   ========================= */
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /* Лайтбокс: клик по большому изображению
       открывает его в большом окне поверх страницы. */
    ...
    // Старт: последняя (обведённая) миниатюра — исходное фото — большой сверху
